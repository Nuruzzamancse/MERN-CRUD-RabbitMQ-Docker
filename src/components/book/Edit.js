      ...
      <div class="container">
        <div class="panel panel-default">
          <div class="panel-heading">
              <h3 className="panel-title"><Link to="/">
                  <span className="glyphicon glyphicon-th-list" aria-hidden="true"></span> Home</Link>
              </h3>
          </div>
          <div class="panel-body">
            ...
            <form onSubmit={this.onSubmit}>
              <div class="form-group">
                <label for="isbn">Book_No:</label>
                <input type="text" class="form-control" name="isbn" value={this.state.book.isbn} onChange={this.onChange} placeholder="Book_No" />
              </div>
              <div class="form-group">
